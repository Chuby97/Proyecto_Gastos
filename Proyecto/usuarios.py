...
# ACTUALMENTE DEBERÍA HACERLO MENU PRINCIPAL AUTOMATICAMENTE
...
def archivar_y_resetear_usuarios():
    usuarios = cargar_usuarios()
    historial_mes = []
    for u in usuarios:
    ...
    nombre_archivo_historial = f"usuarios_historial_{mes_anterior_str}".json
